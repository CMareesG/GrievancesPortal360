            ...
            <div>
              ...
              <div className="flex items-center justify-center gap-1 py-5">
                <Link
                  ...
                  className="flex gap-1 items-center justify-center border p-2 shadow-sm shadow-slate-200 rounded-md hover:bg-slate-300 transition-all duration-300 w-1/2 text-center mx-auto" // Reduced width further
                >
                  <span>
